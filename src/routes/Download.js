...
export default function Download() {
    ...
    const [gettingFileData, setGettingFileData] = useState(true);
    ...
    if (fileFound) { // wenn Datei mit angegebener fileId gefunden wurde
        ...
        return (
            <div className="card bg-danger">
                ...
                <div className="card-body">
                    <h2 className="card-title text-white">Datei nicht gefunden</h2>
        ...
        return (
            <div className="card bg-danger">
                ...
                <div className="card-body">
                    <h2 className="card-title text-white">Datei-Informationen konnten nicht geladen werden</h2>
                    <p className="card-text text-white">Bitte überprüfen Sie Ihre Internetverbindung.</p>
                </div>
            </div>
        );
    }
